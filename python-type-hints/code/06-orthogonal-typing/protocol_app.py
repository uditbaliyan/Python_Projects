...
class Motorcycle:
    def __init__(
        self, model: str, style: MotorcycleType, engine_size: int, off_road: bool
    ):
    ...
    def create_adventure(
        cls, model: str, engine_size: int
    ) -> typing.Self:  # -> "Motorcycle" : # -> Motorcycle?
        bike = Motorcycle(model, MotorcycleType.adventure, engine_size, off_road=True)
        return bike

    def __str__(self) -> str:
        return (
            f"{self.model} {self.engine_size}, type: {self.style}, "
